            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Arcade</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Arcade! 👋</h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p>

              <form id="formAuthentication" class="mb-3" method="POST">
                <div class="mb-3">
                  <label for="email" class="form-label">Email or Username</label>
                  <input type="text" class="form-control" id="username" name="email-username" placeholder="Enter your email or username" autofocus />
                </div>
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input
                      type="password" id="password" class="form-control" name="password" placeholder="enter password" aria-describedby="password" />
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="button" onclick='admin_login();'>Sign in</button>
                </div>
              </form>
...
function admin_login(){
  ...
  $.ajax({
      url: base_url + "backend/admin/check_login",
      type: 'POST',
      data: post_data,
      dataType: "text",
      async: false,
      success: function(data) {
          if (data == 'success') {
              window.location = base_url + 'backend/admin/dashboard'; 
          } else {
