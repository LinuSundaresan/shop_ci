...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<form class="register-form outer-top-xs" role="form">
		<div class="form-group">
		    ...
		    <input type="text" class="form-control unicase-form-control text-input" id="login_username" >
		</div>
	  	<div class="form-group">
		...
		<div class="radio outer-xs">
	  	...
	  	<button type="button" class="btn-upper btn btn-primary checkout-page-button" onclick='customer_login();'>Login</button>
	</form>					
</div>
<!-- Sign-in -->
