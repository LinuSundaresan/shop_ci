    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="Gallery" href="<?php echo base_url()?>uploads/product_images/<?php echo $products->product_image;?>">
                    <img class="img-responsive" alt="" src="<?php echo base_url()?>uploads/product_images/<?php echo $products->product_image;?>" data-echo="<?php echo base_url()?>uploads/product_images/<?php echo $products->product_image;?>" />
                </a>
            ...
            <div id="owl-single-product-thumbnails">
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide1">
                        <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="<?php echo base_url()?>uploads/product_images/<?php echo $products->product_image;?>" />
                    </a>
                </div>
					...
					<div class='col-sm-12 col-md-8 col-lg-8 product-info-block'>
						<div class="product-info">
							<h1 class="name"><?php echo $products->product_name;?></h1>
